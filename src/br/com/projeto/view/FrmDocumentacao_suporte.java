 ...
 * @author JAVA
 */
public class FrmDocumentacao_suporte extends javax.swing.JFrame {
     ...
     */
    public FrmDocumentacao_suporte() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Doc. Suporte");

        txtdocumentacao.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
    ...
    private void txtKeyPressed(java.awt.event.KeyEvent evt) {
        ...
        Documentacao_suporteDAO dao = new Documentacao_suporteDAO();
        List<Documentacao_suporte> lista = dao.buscaLAncPorTipo(tipo);
        DefaultTableModel dados = (DefaultTableModel) tabelaLanc.getModel();
        dados.setNumRows(0);
    ...
    private void tabelaLancMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaLancMouseClicked
        ...
        txtdocumentacao.setText(tabelaLanc.getValueAt(tabelaLanc.getSelectedRow(), 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDocumentacao_suporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDocumentacao_suporte().setVisible(true);
            }
        });
    }
