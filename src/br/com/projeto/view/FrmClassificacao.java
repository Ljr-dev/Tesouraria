 ...
 * @author JAVA
 */
public class FrmClassificacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel30.setText("Classificação");
        ...
        if (tabelaLanc.getColumnModel().getColumnCount() > 0) {
            tabelaLanc.getColumnModel().getColumn(0).setResizable(false);
        }
    ...
    private void txtKeyPressed(java.awt.event.KeyEvent evt) {
        ...
        ClassificacaoDAO dao = new ClassificacaoDAO();
        List<Classificacao> lista = dao.buscaLAncPorTipo(tipo);
        DefaultTableModel dados = (DefaultTableModel) tabelaLanc.getModel();
        dados.setNumRows(0);
    ...
    private void btsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsalvarActionPerformed
        ...
        obj.setClassificacao(txstatus_.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmClassificacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmClassificacao().setVisible(true);
            }
        });
    }
